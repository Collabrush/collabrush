			...
			<div className='space-y-6'>
				...
				<div className='flex items-center justify-between'>
					<div className='text-sm'>
						<div
							...
							onClick={() => {
								toast.error("Kya bey itni jaldi bhul bhi gaya?")
							}}>
				...
				<div>
					<button
						...
						{!loadingSignIn && !signInError && "Log in"}
						{!loadingSignIn &&
							signInError &&
							"Some Error occured - " + signInError?.message}
						{loadingSignIn && !signInError && (
							<>
								<svg
									role='status'
									className='inline mr-2 w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-white'
									viewBox='0 0 100 101'
									fill='none'
