...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      ></div>
      {showAuthModal && (
        <div className="absolute top-0 flex items-center justify-center w-full h-screen m-0">
          <div
            className="absolute top-0 left-0 z-0 w-full h-screen bg-black bg-opacity-50"
            onClick={() => {
      ...
      <footer className="absolute bottom-0 w-full px-4 py-2 text-sm text-center text-white bg-blue-900 lg:relative">
